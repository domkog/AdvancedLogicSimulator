...
import at.fishkog.als.data.meta.MetaValueListener;
...
public abstract class Component extends Data {
	...
	public int extansionWidth;
	public int extansionHeight;
	...
	protected void recalculateConnectorPosition() {
		extansionWidth = (int) ((this.inputs.size() > 2) ? this.bounds.getIntWidth() + ((((this.inputs.size() % 2 != 0) ? this.inputs.size() + 1 : this.inputs.size())) * (this.inputs.get(0).bounds.getIntWidth() * 3)) : this.bounds.getIntWidth());
		extansionHeight = (int) ((this.inputs.size() > 2) ? this.bounds.getIntHeight() + ((((this.inputs.size() % 2 != 0) ? this.inputs.size() + 1 : this.inputs.size())) * (this.inputs.get(0).bounds.getIntHeight() * 3)) : this.bounds.getIntHeight());
		int offsetWidth = (extansionWidth - this.bounds.getIntWidth()) / 2;
		...
		if(this.basicAttributes.getIntOrientation() == 0) {
			...
			double spaceInput = extansionWidth / (inputs.size() + 1);
			for(int i = 0; i < inputs.size(); i++) {
				Connector c = inputs.get(i);
	...
	public int getExtansionSize() {
		...
		if(this.basicAttributes.getIntOrientation() == 0 || this.basicAttributes.getIntOrientation() == 2) return this.extansionHeight;
		else if(this.basicAttributes.getIntOrientation() == 1 || this.basicAttributes.getIntOrientation() == 3) return this.extansionWidth;
		return 0;
	}
	...
	public Location[] getExtansionLocation() {
		...
		if(this.basicAttributes.getIntOrientation() == 0) {
			result[0] = new Location(this.location.getIntX(), this.location.getIntY() - (this.getExtansionSize() / 2) + 20);
			result[1] = new Location(this.location.getIntX(), this.location.getIntY() + bounds.getIntHeight() + (this.getExtansionSize() / 2) - 20);
		} else if(this.basicAttributes.getIntOrientation() == 1) {
			result[0] = new Location(this.location.getIntX() - (this.getExtansionSize() / 2) + 20, this.location.getIntY());
			result[1] = new Location(this.location.getIntX() + bounds.getIntWidth() + (this.getExtansionSize() / 2) - 20, this.location.getIntY());
		} else if(this.basicAttributes.getIntOrientation() == 2) {
			result[0] = new Location(this.location.getIntX() + bounds.getIntWidth(), this.location.getIntY() - (this.getExtansionSize() / 2) + 20);
			result[1] = new Location(this.location.getIntX() + bounds.getIntWidth(), this.location.getIntY() + bounds.getIntHeight() + (this.getExtansionSize() / 2) - 20);
		} else if(this.basicAttributes.getIntOrientation() == 3) {
			result[0] = new Location(this.location.getIntX() - (this.getExtansionSize() / 2) + 20, this.location.getIntY() + this.bounds.getIntHeight());
			result[1] = new Location(this.location.getIntX() + bounds.getIntWidth() + (this.getExtansionSize() / 2) - 20, this.location.getIntY() + this.bounds.getIntHeight());
		}
		return result;
	}
